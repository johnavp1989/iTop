...
EOF
		...
		if ($this->GetOutputFormat() == 'html')
		{
			...
			$sDisplayIcon = utils::GetAbsoluteUrlAppRoot().'images/coredial-logo.png';
			...
			$sHtml .= ' <div id="top-left"></div><div id="logo"><a href="'.htmlentities($sIconUrl, ENT_QUOTES, 'UTF-8').'"><img src="'.$sDisplayIcon.'" title="'.htmlentities($sVersionString, ENT_QUOTES, 'UTF-8').'" style="border:0; margin-top:6px; margin-right:20px;"/></a></div>';
			$sHtml .= ' </div>';
